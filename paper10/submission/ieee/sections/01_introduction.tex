...
The hygiene-augmentation series of this research sequence developed those upstream
components under a consistent pre-registration discipline:
HygieneBench~\cite{paper3hygienebench} for the synthetic
telemetry substrate; HygienePrio~\cite{paper4hygieneprio}
for the scoring rule;
the online-calibration study for the deployable online calibration
recipe; the capacity-decay study for the capacity-arrival
operating regime; the self-trajectory study (its Theorem~1) for the
...
of the HygienePrio scorer, \S X~\cite{paper4hygieneprio})
...
$K = 200$ is excluded by the self-trajectory study Corollary~4: closed-loop
...
This paper is the synthesis paper of the VulnPrio sequence. The sequence's
earlier papers produced components and bounds; AutoHeal integrates them
...
the prior papers' findings (the self-trajectory study Corollary~4 predicts the
K=200 exclusion; the online-calibration study predicts the K=50/100 calibration recipe
choice).
