...
AutoHeal integrates Papers 4--9 of the VulnPrio sequence into a
six-stage self-healing pipeline with pre-registered safety bounds.
...
Papers 4--9 are sufficient to build a self-healing framework whose
