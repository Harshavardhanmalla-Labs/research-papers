...
window-seed-strategy observations summarised with 95\% percentile
bootstrap CIs (10{,}000 resamples). The pre-registered hypothesis
decisions follow the locked tolerances; cell-mean point estimates
have width comparable to the H1 ($0.80$) and H4 ($0.80$) thresholds
at 25 evaluation seeds.
...
\textit{(iv) Selection-policy coupling.} As in Papers~5--9,
...
measured in windows (not days) to match the Paper~5 simulator's
