...
trajectory is the natural follow-up (our self-trajectory diagnosis
quantifies the bias).
...
measured in windows (not days) to match the temporal-stability stage
simulator's
...
the hygiene-augmentation series. AutoHeal's pre-registered safety bounds and
