...
(Paper~4, \S XI, adversarial robustness~\cite{paper4hygieneprio}),
distributional shift
(Paper~4, \S X~\cite{paper4hygieneprio}), or capacity-driven signal
...
\begin{itemize}
\item HygieneBench (Paper~3)~\cite{paper3hygienebench} provides the
...
validity (Paper~4, \S X), and
quantified adversarial robustness (Paper~4, \S XI).
