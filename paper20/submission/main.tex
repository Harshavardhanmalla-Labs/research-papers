...
\caption{High-level architecture of the machine learning-based CVE prioritization framework.}
\label{fig:framework}
\end{figure}
...
\caption{Breakdown of the weighted components in the risk score calculation.}
...
\caption{Comparison of baseline (CVSS-only) vs. proposed framework performance across key metrics.}
...
\caption{SLA compliance and MTTR before and after framework implementation.}
\label{fig:results}
\end{figure}
...
\hangafter=-8
\noindent\llap{\raisebox{\dimexpr\ht\strutbox-\height}[0pt][0pt]{\includegraphics[width=1in,height=1.29in]{author1.png}}%
\hspace{1em}}
