# the CalibScore study, Recommender Talking Points

This file is a set of honest, scoped bullets a letter-writer may draw from
when describing the author's the CalibScore study work. It is **not** a letter, and it
...
- A freeze-invariant contract requires the VulnPrio study SHA-256 manifest to be
 byte-equal before and after every the CalibScore study batch; the manuscript records
...
"In the CalibScore study the author addressed a question that the vulnerability-
