# the CalibScore study, Plain-English Summary (USCIS-Friendly)
...
exploited, to support statistical inference. The CalibScore study measured how many
...
2. **A reproducible sparse-label methodology.** A pre-registered design
 ...
 that ties it back to the VulnPrio study frozen artefact.
...
- That a reproducible artefact chain (pre-registration → runner → audit →
 ...
 prior frozen artefact byte-equal throughout.
