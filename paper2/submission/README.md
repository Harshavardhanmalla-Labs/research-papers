# the CalibScore study, Submission Package (Step 11)
...
The negative-result discipline of the CalibScore study forbids the following claims, none
...
- **The K7 catalog stability question is settled.** It is not; K7 was
 ...
 limitation.
- **Any improvement over the VulnPrio study.** the VulnPrio study frozen outputs were not modified
...
python3 -c "import json; d=json.load(open('paper/report/report_manifest.json')); \
 ...
 print('the VulnPrio study freeze OK')"
