...
\begin{itemize}
  ...
  \item \textbf{C4 --- Cross-paper synthesis:} An explicit cross-paper analysis connecting Paper~1's null result (CVE-level features insufficient), Paper~3's positive hygiene-detection signal (T5 patch hygiene and T2 AD drift), and HygienePrio's positive prioritization result, providing a coherent research narrative about where hygiene signals add value.
\end{itemize}
