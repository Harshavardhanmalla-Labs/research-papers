...
\textbf{Generalizability across sectors.} The EEHDA generator is calibrated for government-shaped public-sector fleet characteristics (following VulnPrio). Commercial enterprise, healthcare, and critical infrastructure fleets may have substantially different hygiene posture distributions, making the specific calibrated weights inapplicable without recalibration.
