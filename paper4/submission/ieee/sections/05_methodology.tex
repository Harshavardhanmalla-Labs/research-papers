...
The decay constant $\lambda = 0.05$ is fixed at the pre-registration default (corresponding to a half-life of approximately 14 days --- matching the CISA BOD 23-01 asset discovery cadence). The sensitivity of results to $\lambda$ is explored informally but not reported as a separate ablation condition.
