...
**Third**, HygienePrio's per-pair dominance over EPSS-only is trajectory-conditional. At K = 50 it is 1.000 under every driver; at K = 200 it is 1.000 under HRS, CVSS, and Random drivers, 0.800 under HP's own driver, and 0.393 under EPSS-only's driver (where both methods collapse together). The temporal-stability study's 96% headline statistic is preserved at moderate capacity and under HRS-blind drivers.
