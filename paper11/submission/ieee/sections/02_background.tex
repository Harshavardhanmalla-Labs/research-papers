...
are precisely the ones agency configuration management databases already record for inventory
...
intervention auditable, since every input to the ranking is an attribute an agency already
