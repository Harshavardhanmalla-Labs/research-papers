...
present work continues a line of context-aware prioritization for government
fleets~\cite{paper1vulnprio}: where the hygiene step moved the unit of analysis from the CVE to
