...
deployable procedures cannot peek into the future. The temporal-stability evaluation's H3
...
In rolling-history calibration, at each scoring window $w$ the weights
used are fit on data from windows $\{1, \ldots, w-1\}$ of a held-out
...
The capacity-sweep evaluation~\cite{paper6capacity} documented that HygienePrio-full's
