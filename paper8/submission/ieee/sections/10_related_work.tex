...
the prior online-calibration evaluation~\cite{paper7online} introduced the rolling-history grid-search
recalibration procedure and reported the capacity-conditional hazard
that motivates this paper. The present sweep inherits the prior online-calibration evaluation's
\textsf{fixed}/\textsf{lag1}/\textsf{offline} strategies and adds the
two smoothing variants.

\textbf{High-capacity collapse.} the capacity-sweep evaluation~\cite{paper6capacity}
...
\textbf{Prior reproducible work on this problem.}
