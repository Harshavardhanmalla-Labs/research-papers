...
Prior work~\cite{paper7online} identified a capacity-dependent hazard
...
and produces a negative cell-mean recovery ratio of $-0.66$. That work
...
This paper tests that fix. The pre-registered protocol (archived with
the reproducibility artifact, locked 2026-06-04 before any
multi-history-calibration result was computed) defines five
...
at high capacity. The recommendation reverses the implicit ``future work will fix this
with smoothing'' framing of~\cite{paper7online}.
\end{itemize}

\subsection{Relationship to Prior Work}

The prior online-calibration evaluation~\cite{paper7online} identified
the high-capacity hazard and proposed smoothing as the fix; this paper falsifies the proposed fix. The result is an
