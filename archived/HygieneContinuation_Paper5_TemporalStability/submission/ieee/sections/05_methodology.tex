...
The scorer is unchanged from Paper~4~\cite{paper4hygieneprio}:
\begin{equation}
\begin{aligned}
...
\label{eq:scorer}
\end{equation}
Weights are fixed at the calibration values reported in Paper~4 and are \textit{not} re-calibrated between windows in the primary evaluation. Hypothesis H3 (\S3.4) tests whether per-window re-calibration would have helped.
