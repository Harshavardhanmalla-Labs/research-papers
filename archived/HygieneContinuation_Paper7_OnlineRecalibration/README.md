# the online-calibration study, Rolling-History Online Calibration for Hygiene-Augmented Vulnerability Prioritization

Pre-registered evaluation of a deployable substitute for the temporal-stability study's
offline-peek H3 calibration ablation. Tests whether one-window-lag
rolling-history grid search can rescue HygienePrio at the capacity-decay study's
...
Reuses the HygienePrio scorer's `hygieneprio` package and the temporal-stability study's `paper5.window_sim`
