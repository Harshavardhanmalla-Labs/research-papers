<!--
The CalibScore study, Step 3.17: Fix F8, Compute budget + fallback locked.
...
No code, no experiments, no F2..F7 changes; the VulnPrio study frozen outputs untouched.
-->

# the CalibScore study, Step 3.17: Fix F8, Compute Budget and Fallback Lock
...
## Invariants honored
The VulnPrio study frozen outputs untouched (no writes anywhere under
