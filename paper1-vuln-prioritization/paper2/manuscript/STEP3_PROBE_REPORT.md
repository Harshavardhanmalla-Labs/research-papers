<!--
The CalibScore study, Step 3: Feasibility Probe build + execution report.
Internal planning document. No fabricated counts. The VulnPrio study (../paper/,
results/primary_full_v1/) is NOT touched by this work.
-->

# the CalibScore study, Step 3: Feasibility Probe Report
...
## Probe build status
- `scripts/paper2_feasibility_probe.py`, built. Read-only w.r.t. The VulnPrio study; writes
