<!--
The CalibScore study, Step 2: Public-Feed Data Feasibility & Calibration Readiness.
...
**Method:** repo inspection only (no fetches, no experiments, the VulnPrio study untouched).
