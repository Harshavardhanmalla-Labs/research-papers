# the CalibScore study, Claim Boundaries
...
any media or social-media post about the CalibScore study. It is *internal*. Read it
before writing or signing off on any external-facing artefact.

## The single sentence the discipline reduces to

**the CalibScore study is a methodology paper and an honest negative result that has not
...
folder, or in any media artefact about the CalibScore study.
