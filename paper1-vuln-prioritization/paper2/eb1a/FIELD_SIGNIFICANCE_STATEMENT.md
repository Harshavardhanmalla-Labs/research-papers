# the CalibScore study, Field Significance Statement

This file explains why the methodology contribution of the CalibScore study matters to
...
The CalibScore study execution couples a failure-aware gate with a pre-registered,
