# the CalibScore study, EB1A Evidence Summary

**Purpose.** This file is the index for the CalibScore study EB1A evidence package. It
...
The CalibScore study has been peer-reviewed, accepted, externally cited, or used outside
this repository.

## What the CalibScore study is

The CalibScore study is a methodology paper with an honest negative result. It documents
...
The CalibScore study is **not** a model-performance paper. It does not claim that any
...
| `ORIGINAL_CONTRIBUTION_STATEMENT.md` | attorney, recommender | what is new in the CalibScore study relative to prior work |
...
| `CLAIM_BOUNDARIES.md` | author, attorney, recommender | the explicit list of what may and may not be claimed about the CalibScore study |
...
- the VulnPrio study freeze invariant preserved (SHA-256 byte-equal before and after
 all the CalibScore study batches).
