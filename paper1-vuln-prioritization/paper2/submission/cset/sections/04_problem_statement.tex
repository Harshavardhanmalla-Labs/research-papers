...
feasibility, content-addressed audit, and the VulnPrio study's freeze invariant on every batch? Pre-registered metrics: \texttt{scheduler\_feasibility\_rate}, \texttt{hash\_chain\_validity}, freeze verification status.
