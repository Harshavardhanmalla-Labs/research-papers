% main.tex, the CalibScore study: CalibScore / Failure-Aware Gate
...
A companion paper constructed a reproducible, reproducibility-audited
...
The CalibScore study, this paper, asks the natural follow-on question: can we calibrate
...
audit integrity, and the VulnPrio study's freeze invariant on every batch?
...
to the VulnPrio study placeholder.
...
The VulnPrio study placeholder vector, reported as a descriptive summary. No
...
rank perturbation relative to the VulnPrio study placeholder is small (median
...
The specific implication for the companion the VulnPrio study benchmark is that the
...
establishes provenance for the design choices in the VulnPrio study's placeholder
...
The VulnPrio study benchmark remains valid and unchanged; its placeholder weights
