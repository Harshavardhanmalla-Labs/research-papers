...
(NIST NVD severity distributions, Verizon DBIR 2026 patch-lag aggregates, CISA
BOD 23-01 telemetry-cadence requirements), with no employer or production data at
any stage.
...
\textbf{86.2\% of (condition, task, method) configurations fail to improve on the
