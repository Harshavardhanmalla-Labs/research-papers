...
one-hidden-layer autoencoder. M8 is implemented using networkx graph features
...
\begin{equation}
  ...
  \label{eq:failure}
\end{equation}
in at least $\lceil 2/3 \times n_{\text{seeds}} \rceil = 2$ of 3 seeds. Flagged
configurations are reported in full; they are not filtered. This protocol was
registered in \texttt{PAPER3\_DECISION\_LOG.md} prior to examining any results.
