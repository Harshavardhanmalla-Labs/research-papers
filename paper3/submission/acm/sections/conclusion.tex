...
entity/event tables. An 810-run evaluation of eight methods under five telemetry
conditions finds that simple rule baselines perform at least as well as unsupervised
ML on 83.8\% of (condition, task, method) configurations. ML adds meaningful value
...
evaluation harness, is available in an anonymized repository (link redacted for
review; the repository and a Zenodo DOI will be released on acceptance).
% [NOTE: add repository URL and Zenodo DOI at camera-ready]
