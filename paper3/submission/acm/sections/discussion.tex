...
The 83.8\% failure rate is not a finding against ML in security operations broadly.
...
All telemetry is synthetic. Structural priors are approximate (DBIR
2026~\cite{verizon_dbir_2026} for patch
...
\paragraph{Medium population scale.}
The medium scale ($n$=1,000 users) limits the statistical power of the evaluation. The
...
or attack-emulation events (Mordor, BOTSv3~\cite{splunk_botsv3}). It is the first benchmark, to our
