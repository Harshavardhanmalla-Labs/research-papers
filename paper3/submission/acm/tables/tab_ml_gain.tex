...
\begin{table}[t]
\centering
\caption{Tasks where ML consistently adds value, i.e., configurations not
  flagged by Eq.~\eqref{eq:failure}: $\Delta$AP $\geq 0.05$ or $\Delta$P@$k$
  $\geq 0.05$ in $\geq$2/3 seeds.}
\label{tab:ml_gain}
\small
