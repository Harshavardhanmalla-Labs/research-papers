# the HygieneBench benchmark, Decision Log
...
**Author/operator:** the HygieneBench benchmark author (single-author track).
...
4. Maintain distinctness from the CalibScore study: lead with anomaly taxonomy + benchmark, not calibration.
5. Maintain distinctness from the VulnPrio study: unit of analysis is the *entity-state record across identity/endpoint/patch*, not the vulnerability×host *pair*.
...
> **the HygieneBench benchmark, Step 2: Prior-Art Falsification & Dataset Feasibility.**
>
...
> 6. **Distinctness reconfirmation vs. The VulnPrio study and the CalibScore study**, written, explicit, point-by-point.
...
> - Do NOT touch the VulnPrio study or the CalibScore study trees.
> - Do NOT write code.
...
- the VulnPrio study untouched (`paper1-vuln-prioritization/paper/`, `paper1-vuln-prioritization/results/primary_full_v1/`, `paper1-vuln-prioritization/src/paper1/`).
- the CalibScore study untouched (`paper1-vuln-prioritization/paper2/`, `paper1-vuln-prioritization/paper2/results/`, `paper1-vuln-prioritization/paper2/audit/`, `paper1-vuln-prioritization/paper2_runtime/`).
...
4. **Distinctness from the CalibScore study confirmed:** the HygieneBench benchmark leads with anomaly taxonomy + benchmark; calibration is not the primary research question.
5. **Distinctness from the VulnPrio study confirmed:** Unit of analysis is entity-state record across identity/endpoint/patch; not vulnerability×host pair.
...
> **the HygieneBench benchmark, Step 3: Experimental Design Lock.**
>
> Inputs:
> - `paper3/feasibility/STEP2_PRIOR_ART_FALSIFICATION.md`
> - `paper3/feasibility/STEP2_DATASET_FEASIBILITY.md`
...
- the VulnPrio study untouched (verified by mtime check; last modified prior to this session).
- the CalibScore study untouched (verified by mtime check; last modified prior to this session).
...
- Calibration: excluded (the CalibScore study's domain).
...
- the VulnPrio study untouched.
- the CalibScore study untouched.
...
- the VulnPrio study untouched. The CalibScore study untouched.
