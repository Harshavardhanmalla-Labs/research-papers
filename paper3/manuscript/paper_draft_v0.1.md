...
**No calibration.** Anomaly scores are not calibrated to probabilities. Calibration is the primary research question of a separate line of work and is excluded from HygieneBench by design.
